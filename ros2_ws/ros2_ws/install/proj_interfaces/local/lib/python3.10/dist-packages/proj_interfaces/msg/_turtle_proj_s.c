...
bool proj_interfaces__msg__turtle_proj__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("proj_interfaces.msg._turtle_proj.TurtleProj", full_classname_dest, 43) == 0);
  }
  proj_interfaces__msg__TurtleProj * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of TurtleProj */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("proj_interfaces.msg._turtle_proj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurtleProj");
